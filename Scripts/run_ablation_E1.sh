#!/usr/bin/env bash
# ============================================================
# Phase E1: Spatial Filter + Semantic Rerank routing
#
# Hard spatial filter (IoU >= tau_iou, correct depth level)
# then semantic rerank by W_proj cosine similarity.
#
# Uses trained W_proj, Stage 3c OFF, Stage 5 OFF (gold text).
# Same 180 test cases as Phase A for direct comparison.
#
# Usage:
#   bash Scripts/run_ablation_E1.sh
# ============================================================
set -euo pipefail
