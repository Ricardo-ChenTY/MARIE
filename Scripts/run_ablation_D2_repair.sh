...
echo "================================================================"
echo "D2: Evidence Card + Repair Executor"
echo "================================================================"

D2_DIR="${PROJ_ROOT}/outputs/ablation_routing_2x2/D2_repair"
mkdir -p "${D2_DIR}"
echo ""
echo ">>> D2 (E1 + Stage 3c + Stage 5 + evidence card + repair executor)"
echo "    OUT: ${D2_DIR}"
