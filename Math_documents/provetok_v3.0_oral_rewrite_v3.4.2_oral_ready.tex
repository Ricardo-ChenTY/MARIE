...
\subsection{Budget Sweep: $k$ vs Faithfulness}

Figure~\ref{fig:budget_sweep} shows the effect of varying the routing budget $k$ (tokens cited per sentence) on spatial consistency.
...
\caption{Budget sweep: $k$ (tokens per sentence) vs spatial faithfulness.
