...
| Config | 配置描述 | BLEU-1 | BLEU-2 | BLEU-3 | BLEU-4 | ROUGE-L | METEOR | F1 |
|--------|---------|--------|--------|--------|--------|---------|--------|----|
| B2' | + Evidence Card v1 | 0.6016 | 0.5488 | 0.5060 | 0.4707 | 0.6425 | 0.6175 | 0.6308 |
| **B2'v2** | **+ Evidence Card v2 (strict)** | **0.6045** | **0.5513** | **0.5081** | **0.4725** | **0.6426** | **0.6190** | **0.6288** |
| C2' | + LLM Judge (Stage 5) | 0.6059 | 0.5541 | 0.5119 | 0.4771 | 0.6431 | 0.6218 | 0.6313 |
| D2 | + Repair executor | 0.6051 | 0.5521 | 0.5090 | 0.4738 | 0.6434 | 0.6217 | 0.6329 |

> F1 = micro-averaged token-level F1 (word overlap precision/recall)。
> NLG 差异 < 1%，确认 evidence gating 不影响文本质量。
> Teacher forcing: planner 使用 reference report 原文作为 topic，故 NLG 分数天然较高（控制变量，非主要贡献指标）。
> 数据来源: `evaluation_5k/metrics_all_conditions.csv`, `evaluation_5k/f1_scores.json`
